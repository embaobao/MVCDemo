...
<!-- TOC -->
- [.NETMVC 基础入门学习笔记](#netmvc-基础入门学习笔记)  
- [Welcome to ASP.NET MVC 记录代码笔记](#welcome-to-aspnet-mvc-记录代码笔记)  
    - [1. MVC项目模板介绍](#1-mvc项目模板介绍)  
        - [1.1 MVC 项目的结构](#11-mvc-项目的结构)  
    - [1.2 MVC 项目的执行阶段](#12-mvc-项目的执行阶段)  
        - [1.3 Controller 与View 的配合关系](#13-controller-与view-的配合关系)  
        - [1.4 ASP.NET MVC模板路由的说明](#14-aspnet-mvc模板路由的说明)  
            - [1.4.2 App_Start文件夹中 RouteConfig类](#142-app_start文件夹中-routeconfig类)  
            - [1.4.3 URL 路由模式的说明](#143-url-路由模式的说明)  
                - [1.4.3.1 MVC和WEB程序 URL 的映射区别](#1431-mvc和web程序-url-的映射区别)  
                - [1.4.3.2 URL 模式](#1432-url-模式)  
    - [2.控制器 （必须用Controller结尾命名的类）](#2控制器-必须用controller结尾命名的类)  
       - [2.1 开始创建一个控制器及对应视图](#21-开始创建一个控制器及对应视图)  
            - [2.1.1 第一种方式](#211-第一种方式)  
            - [2.1.2 第二种方法实现](#212-第二种方法实现)  
            - [2.1.3 返回字符串的操作方法](#213-返回字符串的操作方法)  
        - [2.2](#22)  
    - [3 视图 （控制器的‘对象’-两者呼应）](#3-视图-控制器的对象-两者呼应)  
        - [3.1 Razor 视图引擎](#31-razor-视图引擎)
<!-- /TOC -->
